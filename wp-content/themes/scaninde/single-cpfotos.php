...
<div id="content">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div id="content-page"> 
				<strong class="cat-title"><a href="/fotos/" title="Fotos">Fotos</a></strong>
			...
			<div id="sidebar">
				<?php cp_posts_mais_vistos('Galerias Mais Visitadas','cpfotos',5,'thumb-44x44') ?>
				<?php relacionados_por_cp_tax('Galerias Relacionadas','cpfotos','topico',5,'thumb-44x44'); ?>
				<?php get_sidebar(); ?>
			</div> <!-- sidebar -->
