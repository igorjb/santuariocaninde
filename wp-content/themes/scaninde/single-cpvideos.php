...
<div id="content">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div id="content-page"> 
				<strong class="cat-title"><a href="/videos-santuario/" title="Vídeos do Santuário">Vídeos do Santuário</a></strong>
			...
			<div id="sidebar">
				<?php cp_posts_mais_vistos('Vídeos Mais Visitados','cpvideos',5,'thumb-44x44') ?>
				<?php relacionados_por_cp_tax('Vídeos Relacionados','cpvideos','topico',5,'thumb-44x44'); ?>
				<?php get_sidebar(); ?>
			</div> <!-- sidebar -->
