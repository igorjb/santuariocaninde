...
<div id="content">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div id="content-page"> 
				<strong class="cat-title"><a href="/mensagens-reitor/" title="Mensagens do Reitor">Mensagens do Reitor</a></strong>
			...
			<div id="sidebar">
				...
				<?php relacionados_por_cp_tax('Mensagens Relacionadas','cpmsgreito','topico',5,'thumb-44x44'); ?>
				<?php get_sidebar(); ?>
			</div> <!-- sidebar -->
