...
<div id="content">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div id="content-page"> 
				<strong class="cat-title"><a href="/noticias-destaques/" title="Notícias Destaques">Notícias Destaques</a></strong>
			...
			<div id="sidebar">
				<?php cp_posts_mais_vistos('Notícias Mais Lidas','cpnoticias',5,'thumb-44x44') ?>
				<?php relacionados_por_cp_tax('Notícias Relacionadas','cpnoticias','topico',5,'thumb-44x44'); ?>
				<?php get_sidebar(); ?>
			</div> <!-- sidebar -->
