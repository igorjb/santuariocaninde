...
<div id="content">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div id="content-page"> 
				<strong class="cat-title"><a href="/videos-webtv/" title="Vídeos Web TV">Vídeos Web TV</a></strong>
			...
			<div id="sidebar">
				...
				<?php relacionados_por_cp_tax('Vídeos Relacionados','cpwebtv','topico',5,'thumb-44x44'); ?>
				<?php get_sidebar(); ?>
			</div> <!-- sidebar -->
