...
<div id="content">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div id="content-page"> 
				<strong class="cat-title"><a href="/noticias-acontece/" title="Notícias Acontece">Notícias Acontece</a></strong>
			...
			<div id="sidebar">
				<?php cp_posts_mais_vistos('Notícias Mais Lidas','cpnotactce',5,'thumb-44x44') ?>
				<?php relacionados_por_cp_tax('Notícias Relacionadas','cpnotactce','topico',5,'thumb-44x44'); ?>
				<?php get_sidebar(); ?>
			</div> <!-- sidebar -->
